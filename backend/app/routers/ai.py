...
async def chat(request: ChatRequest, db: AsyncSession = Depends(get_db)):
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).exception("Error in AI chat pipeline")
        reply = f"I'm sorry, I encountered an issue while processing your request: {str(e)}. If this persists, the backend might be temporarily unavailable or restarting."
        actions_taken = []
